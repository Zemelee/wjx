...
readme:
    代码使用规则：
        你需要提前安装好python环境，且已具备上述的所有安装包（numpy、selenium(版本号：3.141.0)，版本号是3就可以）
    ...
    最后的最后：
        如果对代码有任何疑问，欢迎在平台上私我，我看到后会尽快给出解答
        代码可能具有时效性，但短时   间内暂时还不会失效
        如果不会python但确有需要，我也可以帮你刷，具体价格取决于你的问卷复杂度和你需要刷的数量
"""
...
# https://www.wjx.cn/wjx/activitystat/verifyreportpassword.aspx?viewtype=1&activity=209176245&type=1&pt=2
